...
from ffnn_inverse_dynamics.nonamagneto.trajectory_data_generator import NonaMagnetoJointTrajDataGenerator
...
class FFDataSetGenerator():
    def __init__(self, traj_data_path, pass_param=None):
        ...
        self.trajectory_generator = NonaMagnetoJointTrajDataGenerator(traj_data_path, pass_param) 
