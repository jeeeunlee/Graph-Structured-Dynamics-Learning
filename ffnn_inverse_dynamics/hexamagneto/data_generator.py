...
from ffnn_inverse_dynamics.hexamagneto.trajectory_data_generator import HexaMagnetoJointTrajDataGenerator
...
class FFDataSetGenerator():
    def __init__(self, traj_data_path, pass_param=None):
        ...
        self.trajectory_generator = HexaMagnetoJointTrajDataGenerator(traj_data_path, pass_param) 
