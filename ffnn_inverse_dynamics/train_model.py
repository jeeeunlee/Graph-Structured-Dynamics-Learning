...
from ffnn_inverse_dynamics import ffnn_model as myModels

from gn_inverse_dynamics.utils.myutils import *
from ffnn_inverse_dynamics.run_functions import *
...
class TrainModel():
    ...
    def _set_save_and_load_model(self, args):
        ...
        ## define gn_model
        self.model = myModels.MLPFeedForwardModel(latent_size=self.latent_size, 
        ...
        for epoch in range(0, self.epoch_size):
            ...
            if(self.validation_test):
                ...
                if(val_batch_loss_sum*0.7 > batch_loss_sum):
                    ...
                    print(" cnt = {:02d}, val_batch_loss_sum*0.7 > batch_loss_sum ".format(break_count))
                else:
                    break_count = 0
