...
from gn_inverse_dynamics.robot_graph_generator.magneto import magneto_leg_definition as MagnetoLegGraph
from gn_inverse_dynamics.robot_graph_generator.magneto.magneto_leg_graph_base import MagnetoLegGraphBase
