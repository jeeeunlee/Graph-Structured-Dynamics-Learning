...
from gn_inverse_dynamics.robot_graph_generator.nonamagneto.nonamagneto_definition import *
from gn_inverse_dynamics.robot_graph_generator.nonamagneto.leg_edge_graph_generator.nonamagneto_leg_definition import *
from gn_inverse_dynamics.robot_graph_generator.nonamagneto.leg_edge_graph_generator.nonamagneto_dynamic_graph_generator import NonaMagnetoLegDynamicGraphGenerator
...
#############################################################################
#   NonaMagnetoGraphGeneratorBase
#############################################################################
class NonaMagnetoGraphGeneratorBase(RobotGraphDataSetGenerator):
...
#############################################################################
#   NonaMagnetoLegGraphGenerator
#############################################################################

class NonaMagnetoLegGraphGenerator(NonaMagnetoGraphGeneratorBase):
    def __init__(self, urdf_data_path, traj_data_path, pass_param=None):
        log_with_time("NonaMagnetoLegGraphGenerator")
        ...
        dynamic_graph_generator = NonaMagnetoLegDynamicGraphGenerator(traj_data_path, leg_configs, pass_param)

        # create graph base
        robot_graph_base = NonaMagnetoLegGraphBase()
