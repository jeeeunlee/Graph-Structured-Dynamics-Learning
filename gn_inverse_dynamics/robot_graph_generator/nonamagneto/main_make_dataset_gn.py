...
from gn_inverse_dynamics.robot_graph_generator.nonamagneto.nonamagneto_graph_generator import *
...
def make_dataset(args):
    ...
    data_generator = NonaMagnetoLegGraphGenerator(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--raw_data_dir", type=str, default="/a_dataset/rawData/nona_magneto/caseall")
    parser.add_argument("--dataset_dir", type=str, default="/a_dataset/tfData/nona_magneto/GN/caseall")
