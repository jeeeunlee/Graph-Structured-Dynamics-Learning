...
class HexaMagnetoLegDynamicGraphGenerator(DynamicGraphGenerator):
    def __init__(self, traj_data_path, leg_configs, pass_param=None):
        myutils.log_with_time("HexaMagnetoLegDynamicGraphGenerator")
        self.robot_graph_base = HexaMagnetoLegGraphBase()
    ...
    def compute_nodes(self, traj_dict):
        dyn_nodes=[]
        for linkname in HexaMagnetoLegGraph.HexaMagnetoGraphNode:
            if(linkname =='AL'):
    ...
    def compute_edges(self, traj_dict):
        ...
        for legname in HexaMagnetoLegGraph.HexaMagnetoGraphEdge:
            ...
            for legjointname in ['coxa', 'femur', 'tibia']:
                ...
                leg_trq.append( traj_dict['trq'][ HexaMagneto.HexaMagnetoJoint[jointname] ] ) #3
