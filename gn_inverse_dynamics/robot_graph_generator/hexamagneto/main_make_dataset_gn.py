...
from gn_inverse_dynamics.robot_graph_generator.hexamagneto.hexamagneto_graph_generator import *
...
def make_dataset(args):
    ...
    data_generator = HexaMagnetoLegGraphGenerator(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_dir", type=str, default="/a_dataset/tfData/hexa_magneto/GN/caseall")
