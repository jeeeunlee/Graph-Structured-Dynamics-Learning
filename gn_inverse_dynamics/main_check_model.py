...
if __name__ == "__main__":
    ...
    # dataset path
    parser.add_argument("--dataset_path", type=str, default="dataset/magneto/tfData_slope_combination/case1")
    parser.add_argument("--test_dataset_path", type=str, default="dataset/magneto/tfData_slope_combination/case1_test")
