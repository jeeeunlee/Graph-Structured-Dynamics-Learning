...
from gn_inverse_dynamics.check_model.robot_model_check import RobotModelCheckSimulator
...
class InterfaceParams():
    def __init__(self):
        ...
        self.traj_data_dir = "dataset/magneto/rawData_icra/test"
        self.saved_model_path = "result_data/2021icra/case5_32_np3/saved_model"

        self.num_processing_steps = 3
        self.edge_output_size = 3 
        self.edge_latent_size = 32

class MagnetoModelCheckInterface(RobotModelCheckSimulator):
    def __init__(self, param, name="RobotModelCheckInterface"): 
        self.name = name
        self._set_logger(param)
        self._set_params(param) 

        self._set_model(param) # self.model
        self._set_data_generator(param) # self.data_generator
...
if __name__ == "__main__":
    ...
    interface = MagnetoModelCheckInterface(param)
