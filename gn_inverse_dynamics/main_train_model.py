...
from gn_inverse_dynamics.train_model.torque_error_model import TorqueErrorModel
...
if __name__ == "__main__":
    ...
    # dataset path
    parser.add_argument("--dataset_path", type=str, default="dataset/magneto/tfData")
    
    # learning parameters
    parser.add_argument("--learning_rate", type=float, default=5e-4)
    parser.add_argument("--epoch_size", type=int, default=100000)
    parser.add_argument("--batch_size", type=int, default=64)
    parser.add_argument("--edge_latent_size", type=int, default=36)
    parser.add_argument("--num_processing_steps", type=int, default=7)
    parser.add_argument("--edge_output_size", type=int, default=3)
    ...
    parser.add_argument("--test_dataset_path", type=str, default="dataset/magneto/tfData")
