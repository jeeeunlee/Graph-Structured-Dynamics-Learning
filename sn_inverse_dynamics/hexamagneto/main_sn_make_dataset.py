...
from sn_inverse_dynamics.hexamagneto.hexamagneto_data_generator import *
...
if __name__ == "__main__":
    ...
    parser.add_argument("--urdf_path", type=str, default="/gn_inverse_dynamics/robot_graph_generator/hexamagneto/magneto_hexa.urdf")
    parser.add_argument("--raw_data_dir", type=str, default="/a_dataset/rawData/hexa_magneto/case5")
    parser.add_argument("--dataset_dir", type=str, default="/a_dataset/tfData/hexa_magneto/SN/case5")
