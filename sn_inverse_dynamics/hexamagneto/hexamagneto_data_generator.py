...
from gn_inverse_dynamics.robot_graph_generator.hexamagneto.leg_edge_graph_generator.hexamagneto_dynamic_graph_generator import *
...
from sn_inverse_dynamics.hexamagneto.hexamagneto_trajectory_data_generator import HexaMagnetoJointTrajDataGenerator
...
class SNDataSetGenerator():
    def __init__(self, urdf_data_path, traj_data_path, pass_param=None):
        ...
        self.trajectory_generator = HexaMagnetoJointTrajDataGenerator(
