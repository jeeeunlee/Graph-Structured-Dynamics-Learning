...
from sn_inverse_dynamics.magneto.magneto_trajectory_data_generator import MagnetoJointTrajDataGenerator
...
class SNDataSetGenerator():
    def __init__(self, urdf_data_path, traj_data_path, pass_param=None):
        ...
        self.trajectory_generator = MagnetoJointTrajDataGenerator(
