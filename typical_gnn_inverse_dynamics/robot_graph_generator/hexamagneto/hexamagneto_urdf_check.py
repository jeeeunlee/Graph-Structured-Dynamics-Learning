...
# urdf_path = os.path.join( CURRENT_DIR_PATH, 'typical_gnn_inverse_dynamics/robot_graph_generator/hexamagneto/hexamagneto_simple.urdf')
urdf_path = os.path.join( CURRENT_DIR_PATH, 'typical_gnn_inverse_dynamics/robot_graph_generator/hexamagneto/hexamagneto_2_floatingbase.urdf')
