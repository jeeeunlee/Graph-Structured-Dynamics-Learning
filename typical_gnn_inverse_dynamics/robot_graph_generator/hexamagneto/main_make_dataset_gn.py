...
from typical_gnn_inverse_dynamics.robot_graph_generator.hexamagneto.hexamagneto_graph_generator import *
...
def make_dataset(args):
    ...
    data_generator = HexaMagnetoGraphGenerator(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--urdf_path", type=str, default="/typical_gnn_inverse_dynamics/robot_graph_generator/hexamagneto/magneto_hexa.urdf")
    parser.add_argument("--raw_data_dir", type=str, default="/a_dataset/rawData/hexa_magneto/case4")
    parser.add_argument("--dataset_dir", type=str, default="/a_dataset/tfData/hexa_magneto/TGN/case4")
