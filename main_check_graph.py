...
def check_dataset(args):
    ...
    trq1 = myutils.Logger(save_data_dir + '/trq1.csv')
    trq2 = myutils.Logger(save_data_dir + '/trq2.csv')
    trq3 = myutils.Logger(save_data_dir + '/trq3.csv')
    trq4 = myutils.Logger(save_data_dir + '/trq4.csv')
    ...
    for _ in range(100):
        ...
        trq1.record_list(next_graph[1]["edges"][0])
        trq2.record_list(next_graph[1]["edges"][1])
        trq3.record_list(next_graph[1]["edges"][2])
        trq4.record_list(next_graph[1]["edges"][3])

        if(b_first):
            b_first = False
            print("next_graph = ")
            
            print(len(next_graph[0]["edges"][0]))
            print(len(next_graph[0]["nodes"][0]))
            print(len(next_graph[0]["globals"]))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--raw_data_dir", type=str, default="/a_dataset/rawData/ros_pnc/case2")
    parser.add_argument("--save_data_dir", type=str, default="/a_dataset/tfData/ros_pnc/datacheck2")
